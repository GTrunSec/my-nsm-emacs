...
** [[https://github.com/squarepegsys/literate-dotfiles][squarepegsys/literate-dotfiles: My latest dotfiles, with documentation. and in fancy OrgMode]] 
* Package management
...
** doom-modeline
   ...
   #+end_src
** Edition
*** ⚑ WAITING [[https://github.com/antonj/Highlight-Indentation-for-Emacs][antonj/Highlight-Indentation-for-Emacs: Minor modes to highlight indentation guides in emacs.]]
...
** ⚑ WAITING [[https://gitlab.petton.fr/DamienCassou/navigel/][Damien Cassou / navigel · GitLab]]
** Column/line
...
(straight-use-package '(org-ql
    ...
    #+end_src
*** [[https://github.com/legalnonsense/org-deadsync][legalnonsense/org-deadsync: Sync deadlines in orgmode files]]
